 ...
 * family (members, a shopping list, household jobs + subtasks) so the app
...
export async function seedIfEmpty() {
  ...
  const items = [
    ...
    { name: 'Bread',           qty: '1 loaf',  aisle: 'Bakery',      aisleOrder: 4, done: false, addedBy: 'mock_dad'  },
    { name: 'Apples',          qty: '6 pack',  aisle: 'Fruit & veg', aisleOrder: 5, done: false, addedBy: 'mock_sam'  },
